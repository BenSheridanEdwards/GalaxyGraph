...
Default sample data and test fixtures are synthetic. Do not ship generated architecture exports from private applications as examples; adapters should produce `GalaxyGraphDataset` objects that can be reviewed, redacted, or regenerated by the consuming project.
